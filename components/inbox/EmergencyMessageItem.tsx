...
import styles from './EmergencyMessageItem.module.css';

interface EmergencyMessageItemProps {
...
export default function EmergencyMessageItem({
    message,
    isSelected,
    isActive,
    onSelect,
    onClick
}: EmergencyMessageItemProps) {
    return (
        <div
